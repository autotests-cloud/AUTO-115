...
public class AppTests extends TestBase {
    ...
    @DisplayName("https://solomonic.eth.link/")
    void generatedTest() {
        step("Открыть https://solomonic.eth.link/", () -> {
            // todo
        });
    }
    ...
    void titleTest() {
        step("Open url 'https://solomonic.eth.link/'", () ->
            open("https://solomonic.eth.link/"));

        step("Page title should have text 'Solomonic Exchange'", () -> {
            String expectedTitle = "Solomonic Exchange";
